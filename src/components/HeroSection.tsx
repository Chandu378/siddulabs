  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-40 right-20 animate-float opacity-40 hover:opacity-80 transition-opacity duration-300" style={{animationDelay: '2s'}}>
          <Cpu className="text-accent w-14 h-14" />
        </div>
        <div className="absolute bottom-40 left-20 animate-float opacity-35 hover:opacity-75 transition-opacity duration-300" style={{animationDelay: '4s'}}>
        ...
        <div className="absolute bottom-1/4 left-1/4 w-20 h-20 border-2 border-accent/15 animate-rotate-slow hover:border-accent/40 transition-colors duration-300" style={{animationDirection: 'reverse'}}></div>
        
        {/* Additional floating elements */}
        <div className="absolute top-1/3 left-1/3 w-4 h-4 bg-primary/30 rounded-full animate-pulse"></div>
        <div className="absolute bottom-1/3 right-1/3 w-6 h-6 bg-accent/25 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
      </div>
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Enhanced Tagline */}
          <p className="text-2xl md:text-3xl text-muted-foreground mb-4 animate-fade-in font-light" style={{animationDelay: '0.5s'}}>
            <span className="text-primary font-semibold">Engineering</span> Creative Solutions
          </p>
          
          {/* Professional Subtitle */}
          <p className="text-lg text-muted-foreground/90 mb-8 max-w-3xl mx-auto animate-fade-in leading-relaxed" style={{animationDelay: '0.8s'}}>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center animate-fade-in mb-12" style={{animationDelay: '1.2s'}}>
          ...
          {/* Professional Stats */}
          <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto animate-fade-in" style={{animationDelay: '1.5s'}}>
